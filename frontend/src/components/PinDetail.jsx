    ...
    <div className='flex-xl flex-row flex-col m-auto bg-white' style={{ maxWidth: '1500px', borderRadius: '32px' }}>
      ...
      <div className='w-full p-5 flex-1 xl:min-2-620'>
        <div className='flex items-center justify-between'>
          ...
          rel="noreferrer"
          >
            {pinDetail.destination.slice(8, 28)}
          </a>
        </div>
        <div>
          <h1
          className='text-3xl font-bold break-words mt-3'
          >
            {pinDetail.title}
          </h1>
      ...
      <Link to={`user-profile/${pinDetail.postedBy?.sub}`} className="flex gap-2 mt-5 items-center bg-white rounded-lg">
        <img
          className='w-8 h-8 rounded-full object-cover'
          src={pinDetail.postedBy?.picture}
          alt="user-pic"
        />
      ...
      <h2 className='mt-10 text-2xl'>
        ...
        <div className='flex flex-wrap mt-6 gap-3'>
          <Link to={`user-profile/${pinDetail.postedBy?.sub}`}>
          <img
